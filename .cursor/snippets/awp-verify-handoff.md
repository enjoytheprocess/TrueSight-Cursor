...
2. Update `.awp-workspace/workspace-build/2-build/WORK_QUEUE.yaml`: `status: awaiting_human_review`
...
6. Human uses `.awp-workspace/workspace-build/3-verify/acceptance-gate.md` for accept/reject
