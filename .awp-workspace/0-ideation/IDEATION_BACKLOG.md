<!-- Generated from 0-ideation/IDEATION_BACKLOG.yaml — do not edit directly. Run `make render` to update. -->

# Ideation Backlog

_Open ideas. Move promoted, parked, or dropped entries to `archive/IDEATION_BACKLOG.yaml`._
...
**Summary:** Suggest stores to buy missing ingredients with distance and price comparison.
