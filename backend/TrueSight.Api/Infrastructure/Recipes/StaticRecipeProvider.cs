...
public sealed class StaticRecipeProvider : IRecipeProvider
{
    ...
    [
        new(
            ...
            2,
            [
                new("chicken", 300, "g", false),
                new("spinach", 120, "g", false),
                new("eggs", 2, "count", false),
                new("cheese", 40, "g", true)
            ],
            ["Cook chicken pieces until browned.", "Wilt spinach in the skillet.", "Add beaten eggs and finish with cheese if available."]),
        new(
            "vegetable-omelette",
            "Vegetable Omelette",
            ...
            [
                new("eggs", 2, "count", false),
                new("spinach", 60, "g", true),
                new("cheese", 30, "g", true),
                new("tomato", 1, "count", true)
            ],
        ...
        new(
            ...
            2,
            [
                new("pasta", 200, "g", false),
                new("tomato", 2, "count", false),
                new("cheese", 50, "g", true)
            ],
        ...
        new(
            ...
            1,
            [
                new("yogurt", 180, "g", false),
                new("berries", 80, "g", false),
                new("oats", 30, "g", true)
            ],
            ["Spoon yogurt into a bowl.", "Top with berries and oats if available."])
    ];
