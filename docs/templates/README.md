...
| Template | Use for |
|----------|---------|
| [PROJECT_BRIEF_TEMPLATE.md](PROJECT_BRIEF_TEMPLATE.md) | New or reset project brief → `docs/product/project-brief.md` |
| [IDEA_ENTRY_TEMPLATE.md](IDEA_ENTRY_TEMPLATE.md) | Ideation section in `docs/product/ideation.md` |
